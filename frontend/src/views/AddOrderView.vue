        ...
        async assignWorker() {
            ...
            try {
                ...
                const response = await axios.post(
                    `${apiBaseUrl}/transportation-workers/worker/worker-detail/${this.selectedWorkerId}/add-order`,
                    null,
                    {
                        params: {
                ...
                const statusUpdateResponse = await fetch(
                    `${apiBaseUrl}/orders/order-detail/${this.selectedOrderId}/change-status`,
                    {
                        method: 'POST',
                        headers: {
        ...
        async fetchOrders() {
            try {
                const response = await axios.get(
                    `${apiBaseUrl}/orders/check-orders`
                )
