...
export default {
    ...
    methods: {
        ...
        async fetchWorkerProfile() {
            try {
                const response = await axios.get(
                    `${apiBaseUrl}/transportation-workers/${this.id}`
                )
                this.profile = { ...response.data }
                console.log(this.profile.profilePicture)
                this.profilePictureUrl = this.profile.profilePicture
            ...
            try {
                ...
                const url =
                    this.userRole === 'WORKER'
                        ? `${apiBaseUrl}/transportation-workers/update-profile/${this.id}`
                        : `${apiBaseUrl}/users/update-profile/${this.id}`
